const organizeChoreData = (rawData, email) => {
    ...
    for(let x = 0; x < rawData.length; x++){
        ...
        const {chore_id, assign_name, assign_email, chore_name, assign_date, due_date, complete_date, description, group_name, created_by_email, group_id, score, auth, type} = data;
        const g_name = group_name.replace(' ','_');
        const canAddChores = auth;
        const userData = {chore_id, assign_name, assign_email, chore_name,assign_date, due_date, complete_date,description, group_name, created_by_email, group_id, score, type};
        const groupData = {chore_id, assign_name, assign_email, chore_name,assign_date, due_date, complete_date,description, g_name, created_by_email, group_id, score,canAddChores, type};
