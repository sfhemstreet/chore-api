...
const {createTempPassword} = require('../util/createTempPassword');
                    ...
                    .then(users_email => {
                        ...
                        .then(groupID => {
                                ...
                                for(const email in users){
                                    ...
                                    .then(id => {
                                        ...
                                        if(id[0]){
                                            ...
                                            console.log('made pw is ',tempPassword)
                                            ...
                                            bcrypt.hash(tempPassword, 15, (error, hashedPW) => {
                                                ...
                                                .then(loginID => {
                                                    ...
                                                    .then(newID => {
                                                        console.log(newID[0]);
                                                        emailsWithIds[email] = newID[0];
                                                        console.log('what im inserting');
                                                        console.log('groupid', groupID[0]);
                                                        console.log('new id', newID[0]);
                                            ...
                                            if(personProcessed){
                                                counter++;         
                                                console.log('counter is at at', counter)  
                                            }
                                            
                                        }
                                        if(counter === Object.keys(users).length){
                                            console.log('counter is there')
                                            processChores();
                                        }
                            ...
                            function processChores(){
                                ...
                                for(let c in chores){
                                    console.log('inssertt chores');
                                    console.log('chore name ',c );
                                    console.log('assigndate ',todaysDate() );
                                    console.log(' due date', chores[c].dueDate);
                                    console.log(' groupID',groupID[0] );
                                    console.log(' assignID', emailsWithIds[chores[c].assigned]);
                                    console.log('desc', chores[c].description);
                                    db.insert({
                                        chore_name : c,
